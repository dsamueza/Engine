                                ...
                                if (question != null)
                                {
                                    ...
                                    switch (answer.Question.TypePoll.Code)
                                    {
                                        case CTypePoll.One:
                                            ...
                                            question.IdQuestionDetail = resp[0].IdQuestionDetail==null?Guid.Empty: (Guid)resp[0].IdQuestionDetail;
                                        ...
                                        case CTypePoll.Many:
                                            ...
                                            break;
                                        case CTypePoll.Complete:
                                            question.IdQuestionDetail = (Guid)resp[0].IdQuestionDetail;
                                            question.IdAnswer = answerquestion[0].Id;
                                            if (question.QuestionDetailCollection.Where(x => x.Id == answerDetail.IdQuestionDetail).Count() > 0)
                                                question.QuestionComplete.Add(answerDetail.IdQuestionDetail.ToString());
