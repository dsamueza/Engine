...
namespace Mardis.Engine.DataAccess
{
    public class MardisContext : DbContext
    {
        ...
        /// <summary>
        /// Tabla de Codigo Automaticos DINAMICOS
        /// </summary>
        public DbSet<CodeStoreAudit> StoreAuditCodes { get; set; }
        

        /// <summary>
        /// Tabla de Historial de tareas
        /// </summary>
        public DbSet<historialTareas> HistoryTasks { get; set; }
        public DbSet<PollsTask> PollTasks { get; set; }
